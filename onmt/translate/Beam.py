...
class Beam(object):
    ...
    def __init__(self, size, pad, bos, eos,
        ...
        self.next_ys = [self.tt.LongTensor(size) # <class 'list'>: [tensor([1, 1, 1, 1, 1])]
                        .fill_(pad)]
        self.next_ys[0][0] = bos # <class 'list'>: [tensor([2, 1, 1, 1, 1])]
    ...
    def get_current_state(self):
        ...
        return self.next_ys[-1] # Tensor tensor([2, 1, 1, 1, 1])
    ...
    def advance(self, word_probs, attn_out):
        ...
        * `attn_out`- attention at the last step
        ...
        self.attn.append(attn_out.index_select(0, prev_k)) # item (5, 10)
