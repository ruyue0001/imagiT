...
def model_opts(parser):
    ...
    #GAN opetions
    group.add_argument('-NET_E', type=str, default='model/STEM/image_encoder.pth')
    group.add_argument('-CAP_embed_size', type=int, default=256)
    group.add_argument('-CAP_hidden_size', type=int, default=256)
    group.add_argument('-CAP_num_layers', type=int, default=1)
...
def train_opts(parser):
    ...
    group = parser.add_argument_group('Logging')
    group.add_argument('-report_every', type=int, default=200,
...
def train_mm_opts(parser):
    ...
    parser.add_argument('-use_both', action='store_true',
                        help="""Use train&val set for training.""")
    parser.add_argument('--multimodal_model_type', required=True, type=str,
                        choices=['imgd', 'imge', 'imgw', 'src+img', 'graphtransformer', 'gantransformer'],
