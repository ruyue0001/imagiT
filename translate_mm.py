...
def main():
    ...
    elif opt.multimodal_model_type in ['src+img', 'graphtransformer']:
    ...
    translator = onmt.translate.TranslatorMultimodal(model, fields,
                                           ...
                                           multimodal_model_type=opt.multimodal_model_type, opt=opt)
    ...
    #
    # with tables.open_file('attn.h5', mode='w') as f:
    #     ROW_SIZE=
    #     array = f.create_array(f.root, name='data', obj=tables.Float32Atom(), shape=(0, ))
